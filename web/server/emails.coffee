...
Accounts.emailTemplates.verifyEmail.html = (user, url) ->
  return '<h3>Hi online shopper!</h3></br><p>Thank you for signing up. Now you can start using breadcrumbs/ to keep track of your shopping research. Every product you view will be collected by the extension and added to your dashboard.</p></br><h4>Follow this link to verify your email address: </h4>' + url + '<h4>To access your dashboard, please go to: </h4>' + '<a>https://breadcrumbs.ninja/dashboard</a></br><p>If you have any questions, please feel free to contact hi@breadcrumbs.ninja. A team member will respond as soon as possible.</p></br><p>Have fun shopping!</p></br></br><b>Breadcrumbs for Online Shopping <br>Your personal online shopping assistant<br></b>hi@breadcrumbs.ninja | https://breadcrumbs.ninja | https://www.facebook.com/getbreadcrumbs | https://twitter.com/getbreadcrumbs'
